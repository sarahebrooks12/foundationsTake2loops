...
// for (var i = 0; i < 100; i++) {
    // console.log("TWEET TWEET TWEET TWEET TWEET")
// }
// Favorite Foods
...
// var favoriteFoods = ["oreos", "cucumbers", "cereal", "chicken and dumplings", "peanut butter"]
...
// var favoritePastTimes = ["reading", "online window shopping", "being outside", "socializing with friends", "spending time with family"]
// for (var i = 0; i < favoritePastTimes.length; i++) {
//     console.log(`One of my favorite things to do is ${favoritePastTimes[i]}.`)
// }
...
// for (var i = 0; i <favoritePastTimes.length; i++){
//     if (favoritePastTimes[i] === "reading") {
//     console.log(`My absolute favorite thing is ${favoritePastTimes[0]}`)
//     } else { 
//         console.log(`One of my favorite things to do is ${favoritePastTimes[i]}.`)
